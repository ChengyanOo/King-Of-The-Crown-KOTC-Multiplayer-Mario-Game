...
namespace Sprint1.Entities.ItemEntities
{
    public class RedMushroomEntity : ItemEntity
    {
        ...
        public RedMushroomEntity(Game1 game, SpriteEnum spriteType) : base(game, spriteType)
        {
        ...
        public RedMushroomEntity(Game1 game, SpriteEnum spriteType, Vector2 position, bool isRight, Color color, float layerDepth = 0) : base(game, spriteType, position, isRight, color, layerDepth)
        {
